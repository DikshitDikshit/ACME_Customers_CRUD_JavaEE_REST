...
public interface MyConstants {
    ...
    public static final String CUSTOMER_ADDRESS_RESOURCE_PATH = RESOURCE_PATH_ID_PATH + SLASH +
        CUSTOMER_ADDRESS_SUBRESOURCE_NAME;
    public static final String CUSTOMER_ORDER_RESOURCE_PATH = RESOURCE_PATH_ID_PATH + SLASH +
        ORDER_RESOURCE_NAME;
    public static final String CUSTOMER_ORDER_ID_RESOURCE_PATH = SLASH + ORDER_RESOURCE_NAME +
        RESOURCE_PATH_ID_PATH;
    // Security constants
